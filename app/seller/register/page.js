...
export default function SellerRegister() {
  ...
  return (
    <div className="mx-auto max-w-md px-5 py-16">
      ...
      <h1 className="mt-2 text-4xl">Create your seller account</h1>
      <p className="mt-3 text-sm text-[#6b6458]">Already have one? <Link href="/seller/login" className="underline">Sign in</Link>.</p>
      <form onSubmit={onSubmit} className="mt-8 space-y-3">
        ...
        <button className="btn btn-primary w-full" type="submit">Open studio</button>
      </form>
    </div>
  );
}
