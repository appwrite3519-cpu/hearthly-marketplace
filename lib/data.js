...
export const LOCATIONS = {
  ...
  Delta: sorted([
    "Aboh", "Abraka", "Agbarho", "Agbor", "Aladja", "Amukpe", "Anwai", "Asaba",
    "Ashaka", "Boji-Boji Agbor", "Bomadi", "Burutu", "Cable Point", "DBS Asaba",
    "DSC Township", "Edjeba", "Effurun", "Ekpan", "Enerhen", "GRA Asaba",
    "GRA Warri", "Ibusa", "Igbudu", "Isiokolo", "Issele-Uku", "Jakpa Road",
    "Jesse", "Koko", "Kwale", "Nnebisi Road", "Obiaruku", "Ogbe-Ijoh", "Oghara",
    "Ogwashi-Uku", "Okpanam", "Okpe", "Oleh", "Orerokpe", "Osubi", "Otu-Jeremi",
    "Owa-Oyibu", "Ozoro", "Patani", "PTI Road", "Sapele", "Udu", "Ughelli",
    "Umutu", "Uvwie", "Warri"
  ]),
  Edo: sorted([
